...
[Markdown cheat sheet](../../blog/markdown-cheat-sheet.html) — another guide by me.
...
<a href="https://timestampgenerator.com/" target="_blank" rel="noopener noreferrer">UNIX Timestamp Generator</a> — occasionally you might need this for various uses.
...
<a href="https://schema.org/" target="_blank" rel="noopener noreferrer">Schema.org</a> and <a href="https://validator.schema.org/" target="_blank" rel="noopener noreferrer">Structured Data Validator</a> — SEO stuff for Google Search results.
...
<a href="https://www.w3.org/WAI/tips/writing/" target="_blank" rel="noopener noreferrer">Writing for Web Accessibility</a>.
...
<a href="https://www.w3schools.com/accessibility/accessibility_skip_links.php" target="_blank" rel="noopener noreferrer">Accessibility Skip links</a> — I have one on my site as well! Try refreshing the page and then hitting the <kbd>Tab</kbd> button.
...
- ~~Prettier code formatter~~ _I no longer use it for HTML formatting because it adds trailing slashes to void elements_.
- Debugger for Firefox
- HTML CSS Support
- JavaScript (ES6) code snippets
- ~~HUGO Language and Syntax Support~~ _It bugs out occasionally, or maybe I'm just doing something wrong..._
- Live Server
