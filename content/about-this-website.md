...
I use a custom Hugo theme that I made from scratch. For non-techie people, yes, I did code this site _mostly_ "from scratch", as I'm not a fan of no-code website builders or Wordpress. If you want to take a look at my source files (non minified and with comments) to see how I made this or that, you can find them in a <a href="https://github.com/sqvrltastic/sqvrltastic-art-archive-hugo-source-files" target="_blank" rel="noopener noreferrer">dedicated GitHub repo</a>. This site is 100% static, except the external Guestbook, of course.
